...
<h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-title">
            ...
            <div class="mt-2">
              ...
              <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="year" type="text" placeholder="2023-2024">
            </div>
            ...
            <div>
              ...
              <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="start_date" type="date" placeholder="Fecha de inicio">
            </div>
            ...
            <div>
              ...
              <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="end_date" type="date" placeholder="Fecha de fin">
            </div>
            ...
            <div>
              ...
              <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="is_current" type="checkbox">
            </div>
          </div>
    ...
    <table class="table-auto w-full mt-4">
      ...
      <tbody>
        <tr>
          ...
          <td class="border px-4 py-2">2023-06-30</td>
        ...
        <tr>
          <td class="border px-4 py-2">2023-2024</td>
          <td class="border px-4 py-2">2023-07-01</td>
          <td class="border px-4 py-2">2023-12-31</td>
          <td class="border px-4 py-2">No</td>
          <td class="border px-4 py-2">
            <button class="bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-1 px-2 rounded focus:outline-none focus:shadow-outline">Editar</button>
            <button class="bg-red-500 hover:bg-red-700 text-white font-bold py-1 px-2 rounded focus:outline-none focus:shadow-outline">Eliminar</button>
